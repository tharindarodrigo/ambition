                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                                ...
                                <div class="form-group">
                                   ...
                                   <!--<label for="inputUsernameEmail">Username or email</label> -->
                                    <input type="text" id="inputUsernameEmail" class="form-control{{ $errors->has('email') ? ' has-error' : '' }}" name="email" placeholder="Username or email">
                                    @if ($errors->has('email'))
                                ...
                                <div class="col-md-12  row-block form-group" style="padding: 0;">
                                    <button class="btn btn btn-primary btn-block" type="submit" style=" border-color: #FFFFFF; color: #FFFFFF; ">Log In</button>
                            ...
                            <div class="or-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 row-block">
                                        <a href="" class="btn btn-facebook btn-block" style=" border-color: #FFFFFF; color: #FFFFFF; ">
                                            <i class="fa fa-facebook"></i>Facebook</a>
                                    </div>
                                    <div class="col-md-6 row-block">
                                        <a href="" class="btn btn-twitter btn-block" style=" border-color: #FFFFFF; color: #FFFFFF; ">
                                ...
                                <div class="row">
                                    ...
                                    <form role="form">
                                        <div class="form-group col-md-6"  style="padding: 0 2px;">
                                            ...
                                            <input type="text" id="inputUsernameEmail" class="form-control" placeholder="First Name ">
                                        </div>
                                        <div class="form-group col-md-6"  style="padding: 0;">

                                            <input type="text" id="inputUsernameEmail" class="form-control" placeholder="Last Name ">
                                        </div>
                                        <div class="form-group">

                                            <input type="email" id="inputPassword" class="form-control" placeholder="Email">
                                        </div>
                                        <div class="form-group">

                                            <input type="number" id="inputPassword" class="form-control" placeholder="Mobile">
                                        </div>
                                        <div class="form-group col-md-6"  style="padding: 0 2px;">
                                        ...
                                        <div class="form-group col-md-10"  style="padding: 0 2px;">
                                            <p style=" margin-bottom: 0px; padding-top: 11px; color: white;">Agree Terms and Conditions</p>
                                        </div>
                                    ...
                                    <div class="col-md-12 row-block">
                                        <a href="index.html" class="btn btn-primary btn-block" style=" border-color: #FFFFFF; color: #FFFFFF; ">Create New Account</a>
                                    </div>
                                </div>
                            </div>
                        </div>
